...
\input{datos/introduccion}
\input{datos/escenario}
\input{datos/casos-normales}
\input{datos/relaciones}
\input{datos/estados}
\input{datos/variaciones}
\input{datos/rechazos}
\input{datos/registros}
