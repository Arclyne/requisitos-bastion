...
\begin{fichacu}{CU-27}{Jugar contra la IA}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El Servidor de partidas cierra, con la forma de término \texttt{ABANDONO} y sin consecuencias, cualquier \textit{Partida} de \texttt{tipo} \texttt{IA} que el jugador tenga sin terminar, y escribe en su \textit{Participacion} el resultado perdido (\mbox{RN-07}). \textit{(Ver \mbox{FA-03}, \mbox{FA-07})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{NivelIA}, \textit{Modo}:} lee; del nivel, también su \texttt{elo\_\allowbreak{}aproximado}, que es la fuerza que se muestra \textit{(pasos 1, 6)}
