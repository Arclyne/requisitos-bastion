...
\begin{fichacu}{CU-25}{Finalizar la partida y aplicar la progresión}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El Servidor de partidas actualiza la \textit{Partida}: estado \texttt{FINALIZADA}, \texttt{fecha\_\allowbreak{}fin} y forma de término. El ganador, si lo hay, no se escribe en la \textit{Partida}: es la \textit{Participacion} con resultado ganada. \textit{(Ver \mbox{EX-01}, \mbox{FA-08})}
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El Servidor de partidas comprueba que ninguna \textit{Participacion} quede sin resultado: con él quedan terminadas, y sus jugadores vuelven a poder buscar partida (\mbox{RN-09}).
  ...
  \textbf{Flujos alternos} & \cuCelda{\textbf{\mbox{FA-01}: La partida no es clasificatoria}\par
   ...
   & \cuCelda{\textbf{\mbox{FA-08}: La partida tenía enlaces de espectador o venía de una sala}\par
    \begin{cuenum}[start=1]
      \item El Servidor de partidas no escribe en los \textit{EnlaceEspectador} de la partida: dejan de funcionar porque la partida ya no está \texttt{EN\_\allowbreak{}CURSO} (\mbox{RN-06} del \mbox{CU-34}).
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textbf{\textit{Partida}:} escribe estado, \texttt{fecha\_\allowbreak{}fin}, forma de término \textit{(paso 5)}
      \item \textbf{\textit{Participacion}:} escribe resultado, posición, elo final, reloj restante \textit{(pasos 6, 8, 13)}
      \item \textbf{\textit{Jugada}:} lee, para contar muros colocados y para el repaso de la IA \textit{(pasos 9, \mbox{FA-01})}
      \item \textbf{\textit{EstadisticaModo}:} escribe todos los contadores, \texttt{fecha\_\allowbreak{}ultima\_\allowbreak{}partida} y la división \textit{(pasos 9, \mbox{FA-02})}
