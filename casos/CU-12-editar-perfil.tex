...
\begin{fichacu}{CU-12}{Editar el perfil y las preferencias}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      \item El Servidor de partidas verifica que el \texttt{idioma\_\allowbreak{}preferido} recibido sea uno de los idiomas admitidos: \texttt{es-MX} o \texttt{en} (\mbox{D-21}). \textit{(Ver \mbox{FA-07})}
