...
\begin{fichacu}{CU-12}{Editar el perfil y las preferencias}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El Servidor de partidas actualiza en el \textit{Usuario} el \texttt{id\_\allowbreak{}icono}, el \texttt{idioma\_\allowbreak{}preferido} y, si el avatar cambió, la referencia a la imagen. \textit{(Ver \mbox{EX-01})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textit{Usuario}: escribe \texttt{id\_\allowbreak{}icono}, \texttt{idioma\_\allowbreak{}preferido} \textit{(paso 11)}
      \item \textit{UsuarioObjeto}: lee, para comprobar posesión del título \textit{(paso 8)}
      \item \textit{Equipamiento}: actualiza la fila de la ranura de título \textit{(paso 12)}
      \item \textit{EnlaceRed}: borra y crea \textit{(paso 13)}
      \item \textit{Avatar}: crea e invalida el anterior, en el \mbox{FA-01} \textit{(paso \mbox{FA-01})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
