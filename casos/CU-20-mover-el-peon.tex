...
\begin{fichacu}{CU-20}{Mover el peón}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El SJM calcula las casillas alcanzables y las resalta: las ortogonales adyacentes libres de muro, y las de salto si hay un rival adyacente (\mbox{RN-02}, \mbox{RN-03}). \textit{(Ver \mbox{EX-05})}
      \item El Jugador pulsa una casilla resaltada. \textit{(Ver \mbox{FA-01}, \mbox{FA-02}, \mbox{FA-09})}
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El Servidor de partidas pasa el turno al siguiente jugador en orden, saltando a los que ya estén clasificados o hayan abandonado (\mbox{RN-08}), y marca como \texttt{CADUCADA} la \textit{OfertaTablas} pendiente del rival, si la hay (\mbox{RN-05} del \mbox{CU-22}).
    \end{cuenum}} \\
  ...
  \textbf{Flujos alternos} & \cuCelda{\textbf{\mbox{FA-01}: El Jugador pulsa una casilla no alcanzable}\par
   ...
   & \cuCelda{\textbf{\mbox{FA-08}: El peón llega a la fila de meta}\par
    \begin{cuenum}[start=1]
      \item El Servidor de partidas marca la \textit{Participacion} como clasificada, con su posición.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{Partida}:} lee estado y turno; escribe el turno siguiente \textit{(pasos 7, 8, 16)}
      \item \textbf{\textit{Participacion}:} lee la del jugador y las de los rivales \textit{(pasos 6, 10)}
      \item \textbf{\textit{Participacion}:} escribe casilla actual, reloj restante y, en el \mbox{FA-08}, la clasificación \textit{(pasos 14, \mbox{FA-08})}
      \item \textbf{\textit{Jugada}:} lee todas las de la partida, para reconstruir el tablero \textit{(paso 10)}
      \item \textbf{\textit{Jugada}:} crea \textit{(paso 13)}
      \item \textbf{\textit{OfertaTablas}:} marca como \texttt{CADUCADA} la pendiente \textit{(paso 16)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
