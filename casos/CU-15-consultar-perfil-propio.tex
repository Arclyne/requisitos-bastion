...
\begin{fichacu}{CU-15}{Consultar el perfil propio}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textit{Usuario}: lee \texttt{nickname}, \texttt{nivel}, \texttt{experiencia}, \texttt{id\_\allowbreak{}icono}, \texttt{fecha\_\allowbreak{}registro}, \texttt{tipo\_\allowbreak{}cuenta} \textit{(paso 4)}
      \item \textit{Avatar}, \textit{EnlaceRed}, \textit{Equipamiento}: lee \textit{(paso 5)}
      \item \textit{EstadisticaModo}: lee todas las del usuario \textit{(paso 6)}
      \item \textit{Division}: lee los umbrales \textit{(paso 7)}
      \item \textit{Participacion}, \textit{Partida}: lee \texttt{elo\_\allowbreak{}final} y \texttt{fecha\_\allowbreak{}fin} de las clasificatorias \textit{(paso 8)}
      \item \textit{HistorialDivision}: lee los cambios de división \textit{(paso 8)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
