...
\begin{fichacu}{CU-35}{Consultar el ranking}
  ...
  \textbf{Reglas de negocio} & \cuCelda{\begin{cureglas}
      ...
      \item \textbf{\mbox{RN-06}} A igualdad de elo, ordena primero quien alcanzó ese elo antes, para que la posición no cambie entre consultas sin que nadie haya jugado.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{EstadisticaModo}:} lee \texttt{puntos\_\allowbreak{}elo}, \texttt{partidas\_\allowbreak{}jugadas}, \texttt{division} del modo \textit{(pasos 4, 6)}
