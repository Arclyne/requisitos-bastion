...
\begin{fichacu}{CU-35}{Consultar el ranking}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El Servidor de partidas recupera del \textit{Usuario} de cada fila el \texttt{nickname}, el \texttt{id\_\allowbreak{}icono} y la división (\texttt{id\_\allowbreak{}division}) de su estadística, y la página solicitada.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{EstadisticaModo}:} lee \texttt{puntos\_\allowbreak{}elo}, \texttt{partidas\_\allowbreak{}jugadas}, \texttt{id\_\allowbreak{}division} del modo \textit{(pasos 4, 6)}
      \item \textbf{\textit{Usuario}:} lee \texttt{nickname}, \texttt{id\_\allowbreak{}icono}, \texttt{estado\_\allowbreak{}cuenta}, \texttt{codigo\_\allowbreak{}amigo} \textit{(pasos 4, 5, \mbox{FA-06})}
      \item \textbf{\textit{Division}:} lee, para la vista por divisiones \textit{(paso \mbox{FA-05})}
      \item \textbf{\textit{Amistad}:} lee, para el alcance entre amigos \textit{(paso \mbox{FA-03})}
      \item \textbf{\textit{Bloqueo}:} lee, para la búsqueda \textit{(paso \mbox{FA-06})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
