...
\begin{fichacu}{CU-23}{Rendirse}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item Si la partida es de dos jugadores, el flujo continúa en el \mbox{CU-25} Finalizar la partida con la forma de término \texttt{RENDICION} y el rival como ganador. \textit{(Ver \mbox{FA-05}, \mbox{FA-06})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textbf{\textit{Sesion}, \textit{Participacion}:} lee por token y \texttt{elo\_\allowbreak{}inicial} de todos \textit{(pasos 3, 8)}
      \item \textbf{\textit{Partida}, \textit{Modo}:} lee \texttt{estado}, \texttt{tipo} y número de jugadores \textit{(pasos 9, 11)}
      \item \textbf{\textit{OfertaTablas}:} marca las pendientes como \texttt{CADUCADA} \textit{(paso 10)}
      \item \textbf{\textit{Participacion}:} escribe resultado, posición y forma de término, en el \mbox{FA-05} \textit{(paso \mbox{FA-05})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
