...
\begin{fichacu}{CU-37}{Ver la repetición de una partida}
  ...
  \textbf{Reglas de negocio} & \cuCelda{\begin{cureglas}
      ...
      \item \textbf{\mbox{RN-02}} El tablero de cada instante se reconstruye aplicando las jugadas en orden desde el inicio. No se almacenan fotografías del tablero (observación del \mbox{CU-21}); la \textit{Participacion} guarda solo el estado vigente de una partida en curso, y ante una discrepancia mandan las jugadas.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{Participacion}:} lee \texttt{permite\_\allowbreak{}espectadores} de cada jugador, para el acceso público \textit{(paso 5)}
