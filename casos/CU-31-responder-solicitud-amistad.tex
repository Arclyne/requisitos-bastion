...
\begin{fichacu}{CU-31}{Responder una solicitud de amistad}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      \item El Jugador abre la pestaña de solicitudes.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{Solicitud}:} lee las entrantes y enviadas \textit{(pasos 3, 8)}
      \item \textbf{\textit{Solicitud}:} elimina \textit{(pasos 11, \mbox{FA-02}, \mbox{FA-03}, \mbox{FA-04})}
      \item \textbf{\textit{Usuario}:} lee \texttt{nickname} e \texttt{id\_\allowbreak{}icono} de cada jugador \textit{(paso 4)}
      \item \textbf{\textit{EstadisticaModo}:} lee el elo del modo clásico \textit{(paso 4)}
      \item \textbf{\textit{Amistad}:} lee, para contar el límite \textit{(paso 9)}
      \item \textbf{\textit{Amistad}:} crea \textit{(paso 11)}
      \item \textbf{\textit{Bloqueo}:} lee \textit{(paso 10)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
