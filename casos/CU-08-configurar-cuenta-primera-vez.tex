...
\begin{fichacu}{CU-08}{Configurar la cuenta la primera vez}
  ...
  \crudFila{Disparador}{El SJM recibe el perfil de una cuenta cuya \texttt{fecha\_\allowbreak{}configuracion\_\allowbreak{}inicial} es nula, al terminar el \mbox{CU-01} por su \mbox{FA-17} o al terminar el \mbox{CU-06}.}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textit{Usuario}: lee \texttt{fecha\_\allowbreak{}configuracion\_\allowbreak{}inicial}, \texttt{nickname} \textit{(pasos 1, 8)}
      \item \textit{Usuario}: escribe \texttt{id\_\allowbreak{}icono}, \texttt{fecha\_\allowbreak{}configuracion\_\allowbreak{}inicial} \textit{(pasos 13, \mbox{FA-01})}
      \item \textit{UsuarioObjeto}, \textit{ObjetoCosmetico}: lee los peones iniciales poseídos \textit{(pasos 1, 9)}
      \item \textit{Equipamiento}: actualiza la fila de la ranura de peón \textit{(paso 12)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
