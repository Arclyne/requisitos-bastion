...
\begin{fichacu}{CU-13}{Cambiar el nickname}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El Servidor de partidas crea el registro de \textit{HistorialNickname} con el \texttt{nickname} anterior y la fecha del cambio (\mbox{RN-03}); el nuevo queda en el \textit{Usuario}. \textit{(Ver \mbox{EX-01})}
  ...
  \textbf{Postcondiciones} & \cuCelda{\begin{cureglas}
      ...
      \item \textbf{\mbox{POST-02}} Si el caso termina por el FN, existe un \textit{HistorialNickname} con el nombre anterior y la fecha, y el Jugador ya no puede volver a cambiarlo.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{HistorialNickname}:} lee, para comprobar que no se haya gastado \textit{(paso 9)}
      \item \textbf{\textit{HistorialNickname}:} crea \textit{(paso 14)}
      \item \textbf{\textit{Usuario}:} lee \texttt{nickname} de otros, para comprobar unicidad \textit{(paso 12)}
      \item \textbf{\textit{Usuario}:} escribe \texttt{nickname} \textit{(paso 15)}
      \item \textbf{\textit{PalabraProhibida}:} lee el catálogo con ámbito de nickname \textit{(paso 11)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
