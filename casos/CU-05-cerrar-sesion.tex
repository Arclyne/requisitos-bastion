...
\begin{fichacu}{CU-05}{Cerrar sesión}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      \item El Jugador selecciona ``Cerrar sesión'' en la \texttt{GUI\_\allowbreak{}AccountSettings}.
      ...
      \item El Servidor de partidas recupera de la Base de datos la \textit{Sesion} asociada al token. \textit{(Ver \mbox{EX-01})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textit{Sesion}: lee por token, comprueba \texttt{fecha\_\allowbreak{}fin} \textit{(pasos 6, 7)}
      \item \textit{Sesion}: escribe \texttt{fecha\_\allowbreak{}fin}, \texttt{motivo\_\allowbreak{}cierre} \textit{(paso 8)}
      \item \textit{Participacion}: lee, para el \mbox{FA-01} \textit{(paso 2)}
      \item \textit{BitacoraAcceso}: inserta \textit{(paso 10)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
