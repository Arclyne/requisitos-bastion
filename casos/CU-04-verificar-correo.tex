...
\begin{fichacu}{CU-04}{Verificar el correo y activar la cuenta}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      \item El Servidor de partidas cambia el \texttt{estado\_\allowbreak{}cuenta} del \textit{Usuario} a \texttt{ACTIVA}. \textit{(Ver \mbox{EX-01})}
  ...
  \textbf{Postcondiciones} & \cuCelda{\begin{cureglas}
      \item \textbf{\mbox{POST-01}} Si el caso termina por el FN, el \textit{Usuario} tiene \texttt{estado\_\allowbreak{}cuenta} en \texttt{ACTIVA}, y el \mbox{CU-01} ya no lo rechaza por su \mbox{FA-09}.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textbf{\textit{TokenVerificacionCorreo}:} lee \texttt{token\_\allowbreak{}hash}, \texttt{estado}, \texttt{fecha\_\allowbreak{}expiracion} \textit{(pasos 3, 5, 6)}
      ...
      \item \textbf{\textit{Usuario}:} escribe \texttt{estado\_\allowbreak{}cuenta} \textit{(paso 9)}
