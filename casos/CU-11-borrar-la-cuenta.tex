...
\begin{fichacu}{CU-11}{Borrar la cuenta}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textit{Sesion}: lee por token; cierra todas \textit{(pasos 8, 17)}
      \item \textit{Usuario}: lee \texttt{contrasena\_\allowbreak{}hash}, \texttt{contrasena\_\allowbreak{}sal}, \texttt{rol} \textit{(pasos 9, 11)}
      \item \textit{Usuario}: escribe \texttt{estado\_\allowbreak{}cuenta}, \texttt{fecha\_\allowbreak{}baja}; en el \mbox{FA-08} anonimiza \texttt{nickname}, \texttt{correo}, \texttt{contrasena\_\allowbreak{}hash}, \texttt{contrasena\_\allowbreak{}sal} \textit{(pasos 13, \mbox{FA-08})}
      \item \textit{Participacion}: lee, para comprobar que no haya partida en curso \textit{(paso 10)}
      \item \textit{ColaEmparejamiento}, \textit{SalaParticipante}: elimina la del usuario \textit{(paso 14)}
      \item \textit{Solicitud}: elimina las pendientes \textit{(paso 15)}
      \item \textit{Invitacion}: marca como expiradas las pendientes \textit{(paso 15)}
      \item \textit{Reporte}: devuelve a \texttt{PENDIENTE} los que tenía en revisión \textit{(paso 16)}
    \end{cudatos}} \\
   & \cuCelda{\begin{cudatos}
      \item \textit{EnlaceRed}, \textit{HistorialNickname}, \textit{Amistad}, \textit{Silencio}, \textit{Bloqueo}: elimina, en el \mbox{FA-08} \textit{(paso \mbox{FA-08})}
      \item \textit{Avatar}: invalida, en el \mbox{FA-08} \textit{(paso \mbox{FA-08})}
      \item \textit{BitacoraAcceso}: inserta \textit{(pasos 19, \mbox{FA-08})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
