...
\begin{fichacu}{CU-49}{Eliminar a un amigo}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El Servidor de partidas elimina la \textit{Amistad}. \textit{(Ver \mbox{EX-01})}
  ...
  \textbf{Flujos alternos} & \cuCelda{\textbf{\mbox{FA-01}: El Jugador cancela}\par
   ...
   & \cuCelda{\textbf{\mbox{FA-04}: Ya no eran amigos}\par
    \begin{cuenum}[start=1]
      \item El Servidor de partidas no encuentra la \textit{Amistad}: el otro jugador la eliminó antes, lo bloqueó o su cuenta se anonimizó.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{Amistad}:} lee por par ordenado; elimina \textit{(pasos 6, 7)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
