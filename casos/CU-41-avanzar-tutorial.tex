...
\begin{fichacu}{CU-41}{Avanzar en el tutorial}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item Al completar el último paso, el Servidor de partidas escribe la \texttt{fecha\_\allowbreak{}completada} del \textit{ProgresoTutorial}, que lo deja \texttt{completada}.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{ProgresoTutorial}:} crea; escribe \texttt{paso\_\allowbreak{}actual}, \texttt{fecha\_\allowbreak{}actualizacion}, \texttt{fecha\_\allowbreak{}completada} \textit{(pasos 11, 13, \mbox{FA-04})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
