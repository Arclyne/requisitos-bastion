...
\begin{fichacu}{CU-41}{Avanzar en el tutorial}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El SJM muestra el cierre de la lección con las opciones ``siguiente lección'', ``practicar contra la IA'' y ``volver al índice''. \textit{(Ver \mbox{FA-05})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textit{Leccion}: lee el catálogo con su número de pasos \textit{(pasos 3, 7)}
      \item \textit{ProgresoTutorial}: lee \textit{(paso 3)}
      \item \textit{ProgresoTutorial}: crea; escribe \texttt{paso\_\allowbreak{}actual}, \texttt{fecha\_\allowbreak{}actualizacion}, \texttt{completada}, \texttt{fecha\_\allowbreak{}completada} \textit{(pasos 11, 13, \mbox{FA-04})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
