...
\begin{fichacu}{CU-07}{Vincular la cuenta de invitado}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El SJM envía el mensaje \texttt{LINK\_\allowbreak{}ACCOUNT\_\allowbreak{}REQUEST} con los datos capturados, la contraseña, la versión de los términos aceptada y el token de la sesión de invitado. \textit{(Ver \mbox{EX-05}, \mbox{EX-06})}
