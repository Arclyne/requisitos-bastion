...
\begin{fichacu}{CU-29}{Enviar un emote}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      \item El Jugador abre el selector de emotes o pulsa directamente un atajo del 1 al 6. \textit{(Ver \mbox{FA-01})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textit{Participacion}: consulta en memoria del servidor, sin acceso a la base de datos \textit{(paso 4)}
      \item \textit{ParticipacionObjeto}: consulta en memoria el conjunto de emotes fijado al empezar \textit{(paso 6)}
      \item —: ninguna escritura en la base de datos
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
