...
\begin{fichacu}{CU-30}{Agregar a un amigo}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El Servidor de partidas verifica que el destinatario exista y no sea el propio solicitante. \textit{(Ver \mbox{FA-07})}
  ...
  \textbf{Reglas de negocio} & \cuCelda{\begin{cureglas}
   ...
   & \cuCelda{\begin{cureglas}
      ...
      \item \textbf{\mbox{RN-09}} Una solicitud sin responder caduca pasado un plazo, para que las pestañas no acumulen solicitudes muertas.
    \end{cureglas}} \\ \hline
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textit{Usuario}: lee por \texttt{nickname} o \texttt{codigo\_\allowbreak{}amigo} \textit{(paso 5)}
      \item \textit{Bloqueo}: lee, para descartar resultados y rechazar el envío \textit{(pasos 6, 15)}
      \item \textit{Amistad}: lee, para comprobar que no exista y contar el límite \textit{(pasos 12, 14)}
      \item \textit{Solicitud}: lee, para comprobar que no haya pendientes \textit{(paso 13)}
      \item \textit{Solicitud}: crea \textit{(paso 16)}
      \item \textit{Participacion}: lee, para armar las sugerencias \textit{(paso 1)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
