...
\begin{fichacu}{CU-36}{Consultar el historial de partidas}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      \item El SJM despliega la \texttt{GUI\_\allowbreak{}MatchHistory} con una fila por partida: resultado, rivales, modo, forma de término, duración, fecha y cambio de elo en color y con signo. \textit{(Ver \mbox{FA-02}, \mbox{FA-03}, \mbox{FA-04}, \mbox{FA-05}, \mbox{FA-06}, \mbox{FA-07})}
  ...
  \textbf{Reglas de negocio} & \cuCelda{\begin{cureglas}
      ...
      \item \textbf{\mbox{RN-04}} Las partidas de rivales cuya cuenta fue eliminada o anonimizada siguen apareciendo, con el nombre anónimo que recibió la cuenta al darse de baja.
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textit{Participacion}: lee las del jugador y las de sus rivales \textit{(pasos 4, 6)}
      \item \textit{Partida}, \textit{Modo}, \textit{NivelIA}: lee \textit{(pasos 5, 6)}
      \item \textit{Usuario}: lee el \texttt{nickname} de los rivales \textit{(paso 6)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
