...
\begin{fichacu}{CU-46}{Agregar un moderador}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      \item El Administrador selecciona ``agregar moderador''. \textit{(Ver \mbox{FA-06})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textbf{\textit{Sesion}, \textit{Usuario}:} lee el \texttt{rol} del administrador \textit{(paso 7)}
      \item \textbf{\textit{Usuario}:} lee el candidato por \texttt{nickname} o \texttt{codigo\_\allowbreak{}amigo} \textit{(pasos 3, 8)}
      \item \textbf{\textit{Sancion}, \textit{Reporte}:} lee el historial del candidato \textit{(pasos 4, 9)}
      \item \textbf{\textit{Usuario}:} escribe \texttt{rol} \textit{(paso 11)}
      \item \textbf{\textit{BitacoraModeracion}:} inserta \textit{(pasos 11, \mbox{FA-03})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
