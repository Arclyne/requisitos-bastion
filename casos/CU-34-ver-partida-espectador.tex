...
\begin{fichacu}{CU-34}{Ver una partida como espectador}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{EnlaceEspectador}:} lee por \texttt{token\_\allowbreak{}hash}; crea; marca \texttt{activo} en falso al terminar \textit{(pasos \mbox{FA-02}, \mbox{FA-09})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
