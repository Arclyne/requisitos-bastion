...
\begin{fichacu}{CU-14}{Equipar un objeto cosmético}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El SJM muestra la rejilla de los \textit{ObjetoCosmetico} de esa ranura, distinguiendo los que el \textit{Usuario} posee, los que puede comprar con su precio y los que están bloqueados por nivel (\mbox{RN-05}). \textit{(Ver \mbox{EX-02})}
      \item El Jugador selecciona un objeto que posee. \textit{(Ver \mbox{FA-01}, \mbox{FA-02})}
      \item El SJM aplica el objeto a la vista previa, sobre el tablero a tamaño completo y con los peones y muros puestos, sin haberlo equipado todavía (\mbox{RN-06}). \textit{(Ver \mbox{EX-05})}
      \item El Jugador da click en ``Equipar''. \textit{(Ver \mbox{FA-03}, \mbox{FA-07})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{Ranura}:} lee el catálogo de las seis \textit{(paso 1)}
      \item \textbf{\textit{ObjetoCosmetico}:} lee la rejilla de la ranura y comprueba que esté activo \textit{(pasos 3, 9)}
      \item \textbf{\textit{UsuarioObjeto}:} lee, para distinguir lo poseído y acreditar la posesión \textit{(pasos 3, 10)}
      \item \textbf{\textit{Equipamiento}:} actualiza la fila de esa ranura \textit{(paso 11)}
      \item \textbf{\textit{Usuario}:} lee el saldo de monedas y el nivel, para pintar la rejilla \textit{(pasos 1, 3)}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
