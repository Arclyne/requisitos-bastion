...
\begin{fichacu}{CU-02}{Registrar cuenta}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
      ...
      \item El SJM envía el mensaje \texttt{REGISTER\_\allowbreak{}REQUEST} con los datos capturados, la contraseña, la versión de los términos aceptada y el idioma en que se mostró su texto, la huella del dispositivo y la \texttt{version\_\allowbreak{}cliente}. \textit{(Ver \mbox{EX-03}, \mbox{EX-07}, \mbox{EX-08})}
    \end{cuenum}} \\
   & \cuCelda{\begin{cuenum}[start=9]
      \item El Servidor de partidas vuelve a aplicar sobre los datos recibidos todas las validaciones de los pasos 3 a 6, y verifica que el \texttt{idioma\_\allowbreak{}preferido} y el idioma de los términos sean idiomas admitidos, \texttt{es-MX} o \texttt{en} (\mbox{D-21}), sin dar por buena la validación del cliente (\mbox{RN-10}). \textit{(Ver \mbox{FA-07})}
   ...
   & \cuCelda{\begin{cuenum}[start=17]
      ...
      \item El Servidor de partidas registra la \textit{AceptacionTerminos} con la versión aceptada, el idioma en que se mostró su texto (\mbox{D-21}), la fecha y la dirección de red de origen. \textit{(Ver \mbox{EX-04})}
  ...
  \textbf{Postcondiciones} & \cuCelda{\begin{cureglas}
      ...
      \item \textbf{\mbox{POST-04}} Si el caso termina por el FN, existe un registro de \textit{AceptacionTerminos} con la versión aceptada, su idioma, la fecha y la dirección de red de origen.
