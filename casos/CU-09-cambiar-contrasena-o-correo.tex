...
\begin{fichacu}{CU-09}{Cambiar contraseña o correo}
  ...
  \crudFila{Objetivo}{Permitir al Jugador con sesión abierta cambiar su contraseña o su correo, exigiendo la contraseña actual como prueba de identidad, cerrando las demás sesiones cuando cambia la contraseña y sin dejar la cuenta sin un correo verificado mientras se confirma el nuevo.}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      \item \textit{Sesion}: lee por token; cierra las demás \textit{(pasos 6, 11)}
      \item \textit{Usuario}: lee \texttt{contrasena\_\allowbreak{}hash}, \texttt{contrasena\_\allowbreak{}sal}, \texttt{correo}, \texttt{fecha\_\allowbreak{}ultimo\_\allowbreak{}envio\_\allowbreak{}verificacion} \textit{(pasos 7, \mbox{FA-01})}
      \item \textit{Usuario}: escribe \texttt{contrasena\_\allowbreak{}hash}, \texttt{contrasena\_\allowbreak{}sal}, \texttt{fecha\_\allowbreak{}ultimo\_\allowbreak{}envio\_\allowbreak{}verificacion}, \texttt{intentos\_\allowbreak{}fallidos}, \texttt{fecha\_\allowbreak{}ultimo\_\allowbreak{}intento\_\allowbreak{}fallido}, \texttt{bloqueada\_\allowbreak{}hasta} \textit{(pasos 10, \mbox{FA-01}, \mbox{FA-05})}
      \item \textit{TokenRecuperacion}: invalida los pendientes \textit{(paso 12)}
      \item \textit{TokenVerificacionCorreo}: invalida los pendientes y crea uno con \texttt{proposito} y \texttt{correo\_\allowbreak{}destino} \textit{(pasos \mbox{FA-01}, \mbox{FA-09})}
      \item \textit{BitacoraAcceso}: inserta \textit{(pasos 14, \mbox{FA-01}, \mbox{FA-05})}
    \end{cudatos}} \\ \hline
\end{fichacu}
\clearpage
