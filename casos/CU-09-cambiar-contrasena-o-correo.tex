...
\begin{fichacu}{CU-09}{Cambiar contraseña o correo}
  ...
  \textbf{Flujos alternos} & \cuCelda{\textbf{\mbox{FA-01}: El Jugador cambia su correo}\par
    \begin{cuenum}[start=1]
      ...
      \item El Servidor de partidas solicita al Servicio de correo el envío del enlace de confirmación \textbf{al correo nuevo}, y un aviso \textbf{al correo actual} informando de la solicitud, los dos en el \texttt{idioma\_\allowbreak{}preferido} del \textit{Usuario} (\mbox{RN-06}). \textit{(Ver \mbox{EX-06})}
  ...
  \textbf{Datos que toca} & \cuCelda{\begin{cudatos}
      ...
      \item \textbf{\textit{Usuario}:} lee \texttt{contrasena\_\allowbreak{}hash}, \texttt{contrasena\_\allowbreak{}sal}, \texttt{correo}, \texttt{fecha\_\allowbreak{}ultimo\_\allowbreak{}envio\_\allowbreak{}verificacion}, \texttt{idioma\_\allowbreak{}preferido} \textit{(pasos 7, 15, \mbox{FA-01})}
