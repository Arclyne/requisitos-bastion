...
\begin{fichacu}{CU-01}{Iniciar sesión}
  ...
  \textbf{Flujo normal} & \cuCelda{\begin{cuenum}[start=1]
   ...
   & \cuCelda{\begin{cuenum}[start=9]
      ...
      \item El Servidor de partidas verifica que el \texttt{estado\_\allowbreak{}cuenta} del \textit{Usuario} sea \texttt{ACTIVA}. \textit{(Ver \mbox{FA-09}, \mbox{FA-10}, \mbox{FA-17})}
