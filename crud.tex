...
\begin{prototipocrud}{F-07}{Editar perfil}
  ...
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{id\_\allowbreak{}icono}, \texttt{idioma\_\allowbreak{}preferido}.
...
\begin{prototipocrud}{F-10}{Cambiar contraseña}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{BitacoraAcceso}:} \texttt{CAMBIO\_\allowbreak{}CONTRASENA}, o \texttt{CONTRASENA\_\allowbreak{}INCORRECTA} si la actual no coincide.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{contrasena\_\allowbreak{}hash} y \texttt{contrasena\_\allowbreak{}sal}; si la actual es incorrecta, \texttt{intentos\_\allowbreak{}fallidos}, \texttt{fecha\_\allowbreak{}ultimo\_\allowbreak{}intento\_\allowbreak{}fallido} y \texttt{bloqueada\_\allowbreak{}hasta}.
...
\begin{prototipocrud}{F-12}{Eliminar cuenta}
  ...
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{\begin{crudlista}
    \item \textbf{Al darse de baja:} su fila de \textit{ColaEmparejamiento} y de \textit{SalaParticipante}, y sus \textit{Solicitud} pendientes.
    \item \textbf{Al anonimizar:} sus \textit{EnlaceRed}, \textit{Amistad}, \textit{Silencio} y \textit{Bloqueo}.
...
\begin{prototipocrud}{F-28}{Finalizar partida}
  ...
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Partida}:} \texttt{estado} = \texttt{FINALIZADA}, \texttt{fecha\_\allowbreak{}fin}, \texttt{forma\_\allowbreak{}termino}, \texttt{id\_\allowbreak{}ganador}.
    \item \textbf{\textit{Participacion}:} \texttt{resultado}, \texttt{posicion}, \texttt{elo\_\allowbreak{}final}, \texttt{diferencia\_\allowbreak{}elo}, \texttt{reloj\_\allowbreak{}restante}, \texttt{terminada} = 1.
    ...
    \item \textbf{\textit{EnlaceEspectador}:} \texttt{activo} = 0.
...
\begin{prototipocrud}{F-30}{Consultar repetición de una partida}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textbf{\textit{Participacion} y \textit{Usuario}:} \texttt{orden\_\allowbreak{}turno}, \texttt{simbolo\_\allowbreak{}peon}, \texttt{nickname}, y si el jugador participó.
