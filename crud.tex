...
\begin{prototipocrud}{F-01}{Registrar cuenta}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textbf{\textit{PalabraProhibida}:} \texttt{termino}, \texttt{idioma}, \texttt{ambito} y \texttt{activo}, para filtrar el \texttt{nickname}.
  ...
  \crudFila{Datos que se crean}{\begin{crudlista}
    ...
    \item \textbf{\textit{AceptacionTerminos}:} \texttt{version\_\allowbreak{}terminos}, \texttt{fecha\_\allowbreak{}aceptacion}, \texttt{direccion\_\allowbreak{}ip}.
    \item \textbf{\textit{TokenVerificacionCorreo}:} \texttt{token\_\allowbreak{}hash}, \texttt{proposito} = \texttt{ALTA}, \texttt{fecha\_\allowbreak{}expiracion}, \texttt{usado} = 0.
...
\begin{prototipocrud}{F-04}{Verificar correo}
  ...
  \end{crudlista}}
  \crudFila{Datos que se consultan}{\begin{crudlista}
    \item \textbf{\textit{TokenVerificacionCorreo}:} \texttt{token\_\allowbreak{}hash}, \texttt{proposito}, \texttt{correo\_\allowbreak{}destino}, \texttt{usado}, \texttt{fecha\_\allowbreak{}expiracion}.
  ...
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{estado\_\allowbreak{}cuenta} pasa de \texttt{PENDIENTE} a \texttt{ACTIVA}; se escribe \texttt{fecha\_\allowbreak{}verificacion}.
    \item \textbf{\textit{TokenVerificacionCorreo}:} \texttt{usado} = 1, y los demás pendientes del usuario quedan invalidados.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{Ninguno.}
  \crudFila{Reglas de negocio}{\begin{crudlista}
...
\begin{prototipocrud}{F-06}{Consultar perfil de un jugador}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textbf{\textit{EstadisticaModo}, por modo:} \texttt{partidas\_\allowbreak{}jugadas}, \texttt{partidas\_\allowbreak{}ganadas}, \texttt{partidas\_\allowbreak{}perdidas}, \texttt{puntos\_\allowbreak{}elo}, \texttt{elo\_\allowbreak{}maximo}, \texttt{racha\_\allowbreak{}actual}, \texttt{mejor\_\allowbreak{}racha}, \texttt{division}.
...
\begin{prototipocrud}{F-07}{Editar perfil}
  ...
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textit{Usuario}: \texttt{id\_\allowbreak{}icono}, \texttt{idioma\_\allowbreak{}preferido}, \texttt{permite\_\allowbreak{}espectadores}.
...
\begin{prototipocrud}{F-08}{Cambiar nickname}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{HistorialNickname}:} \texttt{nickname\_\allowbreak{}anterior}, \texttt{nickname\_\allowbreak{}nuevo}, \texttt{fecha\_\allowbreak{}cambio}.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
...
\begin{prototipocrud}{F-09}{Recuperar contraseña}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textbf{\textit{TokenRecuperacion}:} \texttt{token\_\allowbreak{}hash}, \texttt{usado}, \texttt{intentos}, \texttt{fecha\_\allowbreak{}expiracion}.
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{TokenRecuperacion}:} \texttt{token\_\allowbreak{}hash}, \texttt{fecha\_\allowbreak{}expiracion}, \texttt{intentos} = 0, \texttt{usado} = 0.
  ...
  \crudFila{Datos que se modifican}{\begin{crudlista}
    ...
    \item \textbf{\textit{TokenRecuperacion}:} \texttt{intentos}, \texttt{usado}.
...
\begin{prototipocrud}{F-10}{Cambiar contraseña o segundo factor}
  ...
  \crudFila{Datos de entrada}{\begin{crudlista}
    ...
    \item O bien: el valor deseado de \texttt{doble\_\allowbreak{}factor\_\allowbreak{}habilitado} y, al activar, un código de prueba.
    \item Token de sesión.
  \end{crudlista}}
  \crudFila{Datos que se consultan}{\begin{crudlista}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textit{BitacoraAcceso}: \texttt{CAMBIO\_\allowbreak{}CONTRASENA}, \texttt{SEGUNDO\_\allowbreak{}FACTOR\_\allowbreak{}ACTIVADO}, \texttt{SEGUNDO\_\allowbreak{}FACTOR\_\allowbreak{}DESACTIVADO}, o \texttt{CONTRASENA\_\allowbreak{}INCORRECTA} si la actual no coincide.
    \item \textit{CodigoSegundoFactor}: el código de prueba, al activar el segundo factor.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textit{Usuario}: \texttt{contrasena\_\allowbreak{}hash} y \texttt{contrasena\_\allowbreak{}sal}, o \texttt{doble\_\allowbreak{}factor\_\allowbreak{}habilitado}; si la actual es incorrecta, \texttt{intentos\_\allowbreak{}fallidos}, \texttt{fecha\_\allowbreak{}ultimo\_\allowbreak{}intento\_\allowbreak{}fallido} y \texttt{bloqueada\_\allowbreak{}hasta}.
...
\begin{prototipocrud}{F-11}{Cambiar correo}
  ...
  \crudFila{Datos que se modifican}{\begin{crudlista}
    ...
    \item \textbf{\textit{TokenVerificacionCorreo}:} los pendientes quedan invalidados al solicitar; el usado se marca al confirmar.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{Ninguno.}
  \crudFila{Reglas de negocio}{\begin{crudlista}
...
\begin{prototipocrud}{F-12}{Eliminar cuenta}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{BitacoraAcceso}:} \texttt{CUENTA\_\allowbreak{}ELIMINADA} y, a los catorce días, \texttt{CUENTA\_\allowbreak{}ANONIMIZADA}.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{estado\_\allowbreak{}cuenta} = \texttt{ELIMINADA} y \texttt{fecha\_\allowbreak{}baja}; a los catorce días, \texttt{nickname} y \texttt{correo} anónimos y contraseña en nulo.
    ...
    \item \textbf{\textit{Avatar}:} \texttt{vigente} = 0 al anonimizar.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{\begin{crudlista}
    \item Al darse de baja: su fila de \textit{ColaEmparejamiento} y de \textit{SalaParticipante}, y sus \textit{Solicitud} pendientes.
    \item Al anonimizar: sus \textit{EnlaceRed}, \textit{HistorialNickname}, \textit{Amistad}, \textit{Silencio} y \textit{Bloqueo}.
...
\begin{prototipocrud}{F-13}{Recuperar una cuenta eliminada}
  ...
  \end{crudlista}}
  \crudFila{Datos que se consultan}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{estado\_\allowbreak{}cuenta}, \texttt{fecha\_\allowbreak{}baja}, \texttt{contrasena\_\allowbreak{}hash}, \texttt{contrasena\_\allowbreak{}sal}.
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{BitacoraAcceso}:} \texttt{resultado} = \texttt{CUENTA\_\allowbreak{}RECUPERADA}.
    \item \textbf{\textit{Sesion}:} la que se abre al continuar el inicio de sesión.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{estado\_\allowbreak{}cuenta} vuelve a \texttt{ACTIVA} y \texttt{fecha\_\allowbreak{}baja} queda en nulo.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{Ninguno.}
  \crudFila{Reglas de negocio}{\begin{crudlista}
...
\begin{prototipocrud}{F-14}{Iniciar sesión}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textit{Sancion}: activas con \texttt{ambito} = \texttt{CUENTA}, también para detectar una suspensión ya vencida.
  ...
  \crudFila{Datos que se crean}{\begin{crudlista}
    ...
    \item \textbf{\textit{CodigoSegundoFactor}:} \texttt{codigo\_\allowbreak{}hash}, \texttt{fecha\_\allowbreak{}generacion}, \texttt{fecha\_\allowbreak{}expiracion}, \texttt{intentos}, \texttt{consumido}, \texttt{canal}, si aplica.
...
\begin{prototipocrud}{F-17}{Buscar partida clasificatoria}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{ColaEmparejamiento}:} \texttt{id\_\allowbreak{}usuario}, \texttt{id\_\allowbreak{}modo}, \texttt{minutos\_\allowbreak{}reloj}, \texttt{elo}, \texttt{fecha\_\allowbreak{}entrada}.
...
\begin{prototipocrud}{F-19}{Crear sala privada e iniciar su partida}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{Sala}:} \texttt{codigo}, \texttt{id\_\allowbreak{}anfitrion}, \texttt{id\_\allowbreak{}modo}, \texttt{muros\_\allowbreak{}por\_\allowbreak{}jugador}, \texttt{minutos\_\allowbreak{}reloj}, \texttt{permite\_\allowbreak{}espectadores}, \texttt{estado} = \texttt{ABIERTA}, \texttt{fecha\_\allowbreak{}creacion}.
  ...
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Sala}:} ajustes; \texttt{estado} = \texttt{EN\_\allowbreak{}PARTIDA} e \texttt{id\_\allowbreak{}partida} al iniciar; \texttt{estado} = \texttt{CERRADA} si el anfitrión sale o por inactividad.
...
\begin{prototipocrud}{F-24}{Rendirse}
  ...
  \crudFila{Datos que se modifican}{\begin{crudlista}
    ...
    \item \textbf{En cuatro jugadores:} la \textit{Participacion} del jugador recibe \texttt{resultado}, \texttt{posicion}, \texttt{forma\_\allowbreak{}termino} = \texttt{RENDICION} y \texttt{terminada} = 1.
...
\begin{prototipocrud}{F-25}{Abandonar la partida o reclamar la victoria}
  ...
  \crudFila{Datos que se modifican}{\begin{crudlista}
    ...
    \item \textbf{\textit{OfertaTablas} pendiente:} \texttt{estado} = \texttt{CADUCADA}.
    \item \textbf{\textit{Participacion} del que abandona en cuatro jugadores:} \texttt{resultado}, \texttt{posicion}, \texttt{forma\_\allowbreak{}termino} = \texttt{ABANDONO}, \texttt{terminada} = 1.
...
\begin{prototipocrud}{F-27}{Jugar contra la IA}
  ...
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Partida}:} \texttt{deshacer\_\allowbreak{}usados}, \texttt{sugerencias\_\allowbreak{}usadas}; se cierra con \texttt{ABANDONO} la partida contra la IA anterior sin terminar.
...
\begin{prototipocrud}{F-30}{Consultar repetición de una partida}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textit{Participacion} y \textit{Usuario}: \texttt{orden\_\allowbreak{}turno}, \texttt{simbolo\_\allowbreak{}peon}, \texttt{nickname}, si el jugador participó y \texttt{permite\_\allowbreak{}espectadores} de cada uno.
...
\begin{prototipocrud}{F-31}{Ver una partida como espectador}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{EnlaceEspectador}:} \texttt{id\_\allowbreak{}partida}, \texttt{id\_\allowbreak{}creador}, \texttt{token\_\allowbreak{}hash}, \texttt{fecha\_\allowbreak{}creacion}, \texttt{activo} = 1, al compartir.
...
\begin{prototipocrud}{F-32}{Consultar ranking}
  ...
  \end{crudlista}}
  \crudFila{Datos que se consultan}{\begin{crudlista}
    \item \textbf{\textit{EstadisticaModo}:} \texttt{puntos\_\allowbreak{}elo}, \texttt{division}, \texttt{partidas\_\allowbreak{}jugadas}.
...
\begin{prototipocrud}{F-33}{Avanzar en el tutorial}
  ...
  \end{crudlista}}
  \crudFila{Datos que se consultan}{\begin{crudlista}
    \item \textbf{\textit{Leccion}:} \texttt{orden}, \texttt{nombre}, \texttt{num\_\allowbreak{}pasos}.
    \item \textbf{\textit{ProgresoTutorial}:} el del jugador en cada lección.
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{ProgresoTutorial}:} \texttt{id\_\allowbreak{}usuario}, \texttt{id\_\allowbreak{}leccion}, \texttt{paso\_\allowbreak{}actual}, \texttt{completada} = 0, \texttt{fecha\_\allowbreak{}actualizacion}, al completar el primer paso de una lección.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{ProgresoTutorial}:} \texttt{paso\_\allowbreak{}actual} y \texttt{fecha\_\allowbreak{}actualizacion} en cada paso; \texttt{completada} = 1 y \texttt{fecha\_\allowbreak{}completada} al terminar.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{Ninguno.}
  \crudFila{Reglas de negocio}{\begin{crudlista}
...
\begin{prototipocrud}{F-35}{Comprar y abrir una caja}
  ...
  \crudFila{Datos que se crean}{\begin{crudlista}
    ...
    \item \textbf{\textit{CajaContenido}:} tres filas con \texttt{id\_\allowbreak{}objeto}, \texttt{convertido} y \texttt{monedas\_\allowbreak{}conversion}.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textbf{\textit{Usuario}:} \texttt{saldo\_\allowbreak{}monedas}, \texttt{cajas\_\allowbreak{}sin\_\allowbreak{}raro}.
...
\begin{prototipocrud}{F-37}{Consultar inventario y tienda}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textbf{\textit{ObjetoCosmetico}:} \texttt{nombre}, \texttt{rareza}, \texttt{precio}, \texttt{nivel\_\allowbreak{}requerido}, \texttt{a\_\allowbreak{}la\_\allowbreak{}venta}, \texttt{activo}.
...
\begin{prototipocrud}{F-46}{Reportar a un jugador}
  ...
  \crudFila{Datos que se consultan}{\begin{crudlista}
    ...
    \item \textit{Participacion}: que denunciante y reportado jugaron la partida adjunta.
...
\begin{prototipocrud}{F-48}{Aplicar una sanción}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textbf{\textit{Sancion}:} \texttt{id\_\allowbreak{}usuario}, \texttt{id\_\allowbreak{}moderador}, \texttt{ambito}, \texttt{tipo}, \texttt{motivo}, \texttt{fecha\_\allowbreak{}inicio}, \texttt{fecha\_\allowbreak{}fin}, \texttt{activa} = 1, \texttt{id\_\allowbreak{}reporte}.
  ...
  \crudFila{Datos que se modifican}{\begin{crudlista}
    ...
    \item \textbf{\textit{Sancion} anterior del mismo ámbito, si se sustituye:} \texttt{activa} = 0, \texttt{fecha\_\allowbreak{}retiro}, \texttt{id\_\allowbreak{}sancion\_\allowbreak{}sustituta}.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{Ninguno.}
  \crudFila{Reglas de negocio}{\begin{crudlista}
...
\begin{prototipocrud}{F-50}{Resolver una apelación}
  ...
  \crudFila{Datos que se modifican}{\begin{crudlista}
    ...
    \item \textbf{\textit{Sancion}:} \texttt{activa} = 0 y \texttt{fecha\_\allowbreak{}retiro}, si se acepta.
