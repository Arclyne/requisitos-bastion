...
\begin{prototipocrud}{F-14}{Iniciar sesión}
  ...
  \crudFila{Actor}{Jugador}
  \crudFila{Prototipos}{6c, Inicio de sesión; 3a, Menú principal · boceto propio.}
  \crudFila{Datos de entrada}{\begin{crudlista}
...
{\footnotesize\textit{Prototipo 3a: Menú principal · boceto propio}}
\end{minipage}
\par\medskip
\end{center}
...
3a & Menú principal · boceto propio & \mbox{F-14} Iniciar sesión \\ \hline
...
3b & Menú · tablero 3D de fondo & Variante de disposición de una pantalla ya seleccionada. & 3a \\ \hline
3c & Menú · barra lateral de navegación & Variante de disposición de una pantalla ya seleccionada. & 3a \\ \hline
3d & Menú · una sola columna centrada & Variante de disposición de una pantalla ya seleccionada. Se prefiere 3a por ser el boceto propio del equipo. & 3a \\ \hline
