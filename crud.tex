...
\begin{prototipocrud}{F-12}{Eliminar cuenta}
  ...
  \end{crudlista}}
  \crudFila{Datos que se crean}{\begin{crudlista}
    \item \textit{BitacoraAcceso}: \texttt{CUENTA\_\allowbreak{}ELIMINADA}.
  \end{crudlista}}
  \crudFila{Datos que se modifican}{\begin{crudlista}
    \item \textit{Usuario}: \texttt{estado\_\allowbreak{}cuenta} = \texttt{ELIMINADA} y \texttt{fecha\_\allowbreak{}baja}; en la misma transacción, \texttt{nickname} y \texttt{correo} anónimos y contraseña en nulo.
    ...
    \item \textit{Avatar}: \texttt{vigente} = 0.
  \end{crudlista}}
  \crudFila{Datos que se eliminan}{\begin{crudlista}
...
\begin{flujo}
  ...
  \item \textbf{Una sola participación sin terminar por jugador.} La regla \mbox{D-11} se garantiza con un índice único filtrado sobre \textit{Participacion} (\texttt{id\_\allowbreak{}usuario}) donde \texttt{terminada} = 0. Funciona precisamente porque incluye las partidas contra la IA: el índice no puede filtrar por el tipo de partida, que vive en otra tabla (\mbox{F-16}, \mbox{F-26}).
