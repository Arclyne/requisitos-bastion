...
\textit{Participacion} & \textit{Reporte} & 0..1:N & La partida adjunta es una que jugó el denunciante (\mbox{CU-42} \mbox{RN-09}; relación Sobre del diagrama). \\ \hline
\textit{Participacion} & \textit{Reporte} & 0..1:N & La partida adjunta es una que jugó el reportado (\mbox{CU-42} \mbox{RN-09}). \\ \hline
