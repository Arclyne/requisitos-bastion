...
\textit{Modo} & (\texttt{codigo}) & Dos modos no tienen la misma clave. \\ \hline
...
\textit{Motivo\-Reporte} & (\texttt{codigo}) & Dos motivos no tienen la misma clave. \\ \hline
...
\textit{Participacion} & (\texttt{id\_\allowbreak{}usuario}), si \texttt{resultado IS NULL} & Una sola participación sin terminar por jugador, incluidas las de la IA (\mbox{D-11}). Filtra por \texttt{resultado} porque un índice filtrado no admite columnas calculadas. \\ \hline
