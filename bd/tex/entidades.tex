...
\textit{Historial\-Nickname} & Dependiente (1:0..1) & Cambio de nombre de una cuenta, para que un jugador reportado no se vuelva irreconocible (\mbox{CU-13} \mbox{RN-03}). Se borra al dar de baja la cuenta (\mbox{CU-11}). \\ \hline
...
\textit{Partida} & Fuerte & Partida clasificatoria, privada o contra la IA. Se guarda completa porque de ella dependen el historial, la repetición, la reconexión y los reportes. \\ \hline
...
\textit{Estadistica\-Modo} & Asociativa (N:M) & Estadísticas y elo de cada cuenta en cada modo, solo de partidas clasificatorias (\mbox{CU-25} \mbox{RN-14}); es la relación N:M entre Usuario y Modo (relación Tiene del diagrama, ahora por modo, \mbox{D-04}). \\ \hline
