...
\textbf{Entidad} & \textbf{Llave primaria} & \textbf{Clase} & \textbf{Otras llaves candidatas} \\ \hline
\endhead
\textit{Ranura} & (\texttt{id\_\allowbreak{}ranura}) & Simple, asignada en la carga & (\texttt{codigo}) \\ \hline
\textit{Objeto\-Cosmetico} & (\texttt{id\_\allowbreak{}objeto}) & Simple, asignada en la carga & (\texttt{codigo}) \\ \hline
\textit{Modo} & (\texttt{id\_\allowbreak{}modo}) & Simple, asignada en la carga & (\texttt{codigo}) \\ \hline
\textit{Division} & (\texttt{id\_\allowbreak{}division}) & Simple, asignada en la carga & (\texttt{codigo}); (\texttt{elo\_\allowbreak{}minimo}) \\ \hline
\textit{Nivel\-IA} & (\texttt{id\_\allowbreak{}nivel\_\allowbreak{}ia}) & Simple, asignada en la carga & (\texttt{codigo}) \\ \hline
\textit{Leccion} & (\texttt{id\_\allowbreak{}leccion}) & Simple, asignada en la carga & (\texttt{codigo}); (\texttt{orden}) \\ \hline
\textit{Tipo\-Caja} & (\texttt{id\_\allowbreak{}tipo\_\allowbreak{}caja}) & Simple, asignada en la carga & (\texttt{codigo}) \\ \hline
...
\textit{Motivo\-Reporte} & (\texttt{id\_\allowbreak{}motivo}) & Simple, asignada en la carga & (\texttt{codigo}) \\ \hline
