...
\begin{longtable}{|L{0.061\linewidth}|L{0.152\linewidth}|L{0.174\linewidth}|L{0.109\linewidth}|L{0.141\linewidth}|L{0.109\linewidth}|L{0.078\linewidth}|L{0.044\linewidth}|}
\hline
\textbf{Partida} & \textbf{Tipo} & \textbf{Modo} & \textbf{Estado} & \textbf{Jugador} & \textbf{Cuenta} & \textbf{Resultado} & \textbf{Elo final} \\ \hline
\endfirsthead
\hline
\textbf{Partida} & \textbf{Tipo} & \textbf{Modo} & \textbf{Estado} & \textbf{Jugador} & \textbf{Cuenta} & \textbf{Resultado} & \textbf{Elo final} \\ \hline
\endhead
