...
\begin{longtable}{|L{0.330\linewidth}|L{0.145\linewidth}|L{0.129\linewidth}|L{0.322\linewidth}|}
\hline
\textbf{Variación} & \textbf{Tabla} & \textbf{Registro} & \textbf{Dato que la muestra} \\ \hline
\endfirsthead
\hline
\textbf{Variación} & \textbf{Tabla} & \textbf{Registro} & \textbf{Dato que la muestra} \\ \hline
\endhead
