...
Motivo: la restricción existía para que dos clientes no mandaran jugadas en nombre del mismo jugador, pero eso se resuelve en la partida, no en el inicio de sesión. Atarlo al login obligaba además a cerrar la sesión del otro dispositivo para poder entrar, que es fricción sin ganancia.
